...
//	METODI USER
	...
	public static void updateUserCard(User u, String s) {
		DaoFactory.getDaoFactory().getUserDao().updateCardInsert(u, s);
	}
	
	public static void updateUserCardPoint(User u, Integer p) {
